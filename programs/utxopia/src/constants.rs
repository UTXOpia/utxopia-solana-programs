...
/// BPF upgradeable loader (BPFLoaderUpgradeab1e11111111111111111111111). Owner of the
/// ProgramData account that holds this program's upgrade authority — the only global admin
/// identity available to a program that has no canonical pool.
...
/// Native SOL mint for the legacy Token program
...
pub const NATIVE_SOL_2022_MINT: [u8; 32] = [
